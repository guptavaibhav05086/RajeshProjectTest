...
@Component({
  selector: 'app-approve-manufacture',
  templateUrl: './approve-manufacture.component.html',
  // styleUrls: ['./approve-manufacture.component.css']
})
export class ApproveManufactureComponent implements OnInit {
  ...
  getRegisteredManufacturers() {
    this._registrationService.getManufacturerList().subscribe(
      tile => {
